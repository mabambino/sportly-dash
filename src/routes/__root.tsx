...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ClubHaus — Modern sports club management" },
      ...
      { property: "og:title", content: "ClubHaus — Modern sports club management" },
      ...
      { name: "twitter:title", content: "ClubHaus — Modern sports club management" },
